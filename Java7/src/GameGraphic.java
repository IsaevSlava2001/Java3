...
public class GameGraphic extends JFrame
{
    ...
    public GameGraphic()
    {
        ...
        addFirst.addActionListener(e->{firstStart.setText(firstStart.getText()+curAdd.getText());
        ...
        addSecond.addActionListener(e->{secondStart.setText(secondStart.getText()+curAdd.getText());
            curAdd.setText((new Integer(Integer.parseInt(curAdd.getText())+1)).toString());
            if(secondStart.getText().length() == 5)
            {
        ...
        playButton.addActionListener(e->{JOptionPane.showMessageDialog(this, new GameQueue(firstStart.getText(), secondStart.getText()).play());
            firstStart.setText("");
            secondStart.setText("");
            curAdd.setText("0");
    ...
    {
        new GameGraphic().setVisible(true);
    }
}